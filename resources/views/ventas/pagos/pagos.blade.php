        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="small-box bg-info">
              ...
              <div class="inner">
                <h3>$ {{number_format($pago->montot,2)}}</h3>
                <p>Pagos</p>
              </div>
              <div class="icon">
                ...
                <div class="tab-content" id="custom-tabs-four-tabContent">                       
                    ...
                    <table class="table table-hover text-nowrap">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            @if($pago->status!=0)
                            <button class="btn btn-danger btn-sm"  data-toggle="modal" data-target="#modalcancelarpago" data-id="{{$pago->id}}" data-nombre="{{$pago->obra}}" data-monto="$ {{number_format($pago->monto)}}" onclick="PrepararCancelacion(this,'CancelarPagov');">
                  ...
                  <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td title="{{$clientegasto->nombre}}">{{strlen($clientegasto->nombre) > 40 ? substr($clientegasto->nombre,0,40) : $clientegasto->nombre}}</td>
...
@include('ventas.pagos.modals.modalpago')
@include('ventas.pagos.modals.modalcancelarpago')
