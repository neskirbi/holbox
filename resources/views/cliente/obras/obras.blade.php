                    ...
                    <table class="table table-hover text-nowrap">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                          <a href="obras/{{$obra->id}}" class="btn btn-info btn-sm" ><i class="fa fa-eye" aria-hidden="true"></i> Ver</a>
                          </td>
                          <td>
                          ...
                          <td>
                            ...
                            <form action="obras/{{$obra->id}}" method="POST"  class="d-inline p-2">
                                {{ csrf_field() }}
                                <input type="hidden" name="_method" value="DELETE">
                                <button  id="borrar" class="borrar btn btn-danger btn-sm" data-texto="¿Deseas quitar esta obra?"><i class="fa fa-times" aria-hidden="true"></i></button>
