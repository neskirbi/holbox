        ...
        <div class="row" >
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <div class="p-2">
                  <a href="{{url('etransporte')}}/create" class="btn btn-primary"><span><i class="fa fa-plus" aria-hidden="true"></i></span> Registrar Empresa</a>
                </div>
                <div class="row">
                  <div class="col-sm-12">
                      ...
                      <tbody>
                        ...
                        @foreach($transportes as $transporte)
                          <tr>
                            ...
                            <td>
                              <a href="{{url('etransporte')}}/{{$transporte->id}}" class="btn btn-info btn-sm d-inline p-2" ><i class="fa fa-eye" aria-hidden="true"></i> Revisar</a>
                            </td>
                          </tr>
