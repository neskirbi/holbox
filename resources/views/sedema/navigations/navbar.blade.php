<div class="bg-light" style=" height:60px; width:100%;  ">
    <a class="navbar-brand" href="home"><img src="{{asset('images/logot.png')}}" height="55px" style="margin-left:10px;"></a>
        ...
        <nav class="navbar navbar-expand-lg navbar-light navbar-loght ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto extra-nav">
                    ...
                    <!--<li class="nav-item active">
                        <a class="nav-link"  data-toggle="modal" data-target="#loginadmin" href="#">Administrar <span class="sr-only">(current)</span></a>
                    </li>
                    
                    <li class="nav-item active">
                        <a class="nav-link" data-toggle="modal" data-target="#loginres" href="#">Residentes <span class="sr-only">(current)</span></a>
                    </li>

                    <li class="nav-item dropdown" style="width:100px;">
                        <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Clientes</a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
