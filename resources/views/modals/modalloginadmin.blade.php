<!-- ModalRegistro -->
<div class="modal fade bd-example-modal-sm" id="loginadmin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">            
                ...
                <div class="form-group">
                    ...
                    <br>
                    <a class="btn btn-default btn-outline-secondary" href="PassResetAdmin">Recuperar</a>                    
                </div>
