                ...
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        ...
                        <li class="nav-item active">
                                <a class="nav-link active" onclick="VentanasTitulos(this);" data-text="Reporte Josué"  data-toggle="pill" href="#report" role="tab">
                                    <i class="fa fa-building" aria-hidden="true"></i> Reporte Josué
