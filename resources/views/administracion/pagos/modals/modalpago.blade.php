    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="CargarPagos" method="POST">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6"> 
                            <div class="form-group">
                                <label for="negocio">Establecimiento</label>
                                <select class="form-control" name="negocio" id="negocio" aria-invalid="false" onchange="GetGeneradorDatos(this);">
