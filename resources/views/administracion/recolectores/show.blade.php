                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('recolectoresadm.update', $recolector->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                                ...
                                                <div class="col-md-6">
                                                  <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                      ...
                                                      <input required type="number" data-telefono="{{ $recolector->telefono }}" onkeyup="Cambio(this);" class="form-control" id="telefono" placeholder="Teléfono" aria-invalid="false" maxlength="50" value="{{ $recolector->telefono }}" >
                                                    </div>
                                                  </div>
                                                </div>
                                              </div>
